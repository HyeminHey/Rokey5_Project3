...
#include "qulido_robot_msgs/msg/detail/motion_primitive__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // primitive
#include "rosidl_runtime_c/string_functions.h"  // primitive

// forward declare type support functions


using _MotionPrimitive__ros_msg_type = qulido_robot_msgs__msg__MotionPrimitive;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->primitive;
  ...
  void * untyped_ros_message)
{
  ...
  _MotionPrimitive__ros_msg_type * ros_message = static_cast<_MotionPrimitive__ros_msg_type *>(untyped_ros_message);
  // Field name: primitive
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->primitive.data) {
      rosidl_runtime_c__String__init(&ros_message->primitive);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->primitive,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'primitive'\n");
      return false;
    }
  }
...
static uint32_t _MotionPrimitive__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_qulido_robot_msgs__msg__MotionPrimitive(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = qulido_robot_msgs__msg__MotionPrimitive;
    is_plain =
      (
      offsetof(DataType, gripper_width) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _MotionPrimitive__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_qulido_robot_msgs__msg__MotionPrimitive(

...
static const _AiCompute_Request_type_support_symbol_names_t _AiCompute_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, qulido_robot_msgs, srv, AiCompute_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, qulido_robot_msgs, srv, AiCompute_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, qulido_robot_msgs, srv, AiCompute_Request)() {
  return &::qulido_robot_msgs::srv::rosidl_typesupport_c::AiCompute_Request_message_type_support_handle;
}
...
static const _AiCompute_Response_type_support_symbol_names_t _AiCompute_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, qulido_robot_msgs, srv, AiCompute_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, qulido_robot_msgs, srv, AiCompute_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, qulido_robot_msgs, srv, AiCompute_Response)() {
  return &::qulido_robot_msgs::srv::rosidl_typesupport_c::AiCompute_Response_message_type_support_handle;
}
...
static const _AiCompute_type_support_symbol_names_t _AiCompute_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, qulido_robot_msgs, srv, AiCompute)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, qulido_robot_msgs, srv, AiCompute)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, qulido_robot_msgs, srv, AiCompute)() {
  return &::qulido_robot_msgs::srv::rosidl_typesupport_c::AiCompute_service_type_support_handle;
}

...
static const _GetBoardState_Request_type_support_symbol_names_t _GetBoardState_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, qulido_robot_msgs, srv, GetBoardState_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, qulido_robot_msgs, srv, GetBoardState_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, qulido_robot_msgs, srv, GetBoardState_Request)() {
  return &::qulido_robot_msgs::srv::rosidl_typesupport_c::GetBoardState_Request_message_type_support_handle;
}
...
static const _GetBoardState_Response_type_support_symbol_names_t _GetBoardState_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, qulido_robot_msgs, srv, GetBoardState_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, qulido_robot_msgs, srv, GetBoardState_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, qulido_robot_msgs, srv, GetBoardState_Response)() {
  return &::qulido_robot_msgs::srv::rosidl_typesupport_c::GetBoardState_Response_message_type_support_handle;
}
...
static const _GetBoardState_type_support_symbol_names_t _GetBoardState_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, qulido_robot_msgs, srv, GetBoardState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, qulido_robot_msgs, srv, GetBoardState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, qulido_robot_msgs, srv, GetBoardState)() {
  return &::qulido_robot_msgs::srv::rosidl_typesupport_c::GetBoardState_service_type_support_handle;
}

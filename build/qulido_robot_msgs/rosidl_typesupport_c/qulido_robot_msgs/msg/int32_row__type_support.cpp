...
static const _Int32Row_type_support_symbol_names_t _Int32Row_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, qulido_robot_msgs, msg, Int32Row)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, qulido_robot_msgs, msg, Int32Row)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, qulido_robot_msgs, msg, Int32Row)() {
  return &::qulido_robot_msgs::msg::rosidl_typesupport_c::Int32Row_message_type_support_handle;
}

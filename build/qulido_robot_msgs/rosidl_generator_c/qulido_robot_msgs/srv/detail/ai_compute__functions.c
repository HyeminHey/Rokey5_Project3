...
qulido_robot_msgs__srv__AiCompute_Request__init(qulido_robot_msgs__srv__AiCompute_Request * msg)
{
  ...
  // added
  if (!rosidl_runtime_c__int32__Sequence__init(&msg->added, 0)) {
    qulido_robot_msgs__srv__AiCompute_Request__fini(msg);
    return false;
  }
  return true;
}
...
qulido_robot_msgs__srv__AiCompute_Request__fini(qulido_robot_msgs__srv__AiCompute_Request * msg)
{
  ...
  // added
  rosidl_runtime_c__int32__Sequence__fini(&msg->added);
}
...
qulido_robot_msgs__srv__AiCompute_Request__create()
{
  ...
  qulido_robot_msgs__srv__AiCompute_Request * msg = (qulido_robot_msgs__srv__AiCompute_Request *)allocator.allocate(sizeof(qulido_robot_msgs__srv__AiCompute_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(qulido_robot_msgs__srv__AiCompute_Request));
  bool success = qulido_robot_msgs__srv__AiCompute_Request__init(msg);
  if (!success) {
...
qulido_robot_msgs__srv__AiCompute_Request__Sequence__init(qulido_robot_msgs__srv__AiCompute_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  qulido_robot_msgs__srv__AiCompute_Request * data = NULL;

  if (size) {
    data = (qulido_robot_msgs__srv__AiCompute_Request *)allocator.zero_allocate(size, sizeof(qulido_robot_msgs__srv__AiCompute_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = qulido_robot_msgs__srv__AiCompute_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        qulido_robot_msgs__srv__AiCompute_Request__fini(&data[i - 1]);
      }
...
qulido_robot_msgs__srv__AiCompute_Request__Sequence__fini(qulido_robot_msgs__srv__AiCompute_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      qulido_robot_msgs__srv__AiCompute_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  qulido_robot_msgs__srv__AiCompute_Request__Sequence * array = (qulido_robot_msgs__srv__AiCompute_Request__Sequence *)allocator.allocate(sizeof(qulido_robot_msgs__srv__AiCompute_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = qulido_robot_msgs__srv__AiCompute_Request__Sequence__init(array, size);
  if (!success) {
...
qulido_robot_msgs__srv__AiCompute_Request__Sequence__destroy(qulido_robot_msgs__srv__AiCompute_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    qulido_robot_msgs__srv__AiCompute_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
qulido_robot_msgs__srv__AiCompute_Request__Sequence__are_equal(const qulido_robot_msgs__srv__AiCompute_Request__Sequence * lhs, const qulido_robot_msgs__srv__AiCompute_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!qulido_robot_msgs__srv__AiCompute_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  qulido_robot_msgs__srv__AiCompute_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(qulido_robot_msgs__srv__AiCompute_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    qulido_robot_msgs__srv__AiCompute_Request * data =
      (qulido_robot_msgs__srv__AiCompute_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!qulido_robot_msgs__srv__AiCompute_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          qulido_robot_msgs__srv__AiCompute_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!qulido_robot_msgs__srv__AiCompute_Request__copy(
...
qulido_robot_msgs__srv__AiCompute_Response__init(qulido_robot_msgs__srv__AiCompute_Response * msg)
{
  ...
  // ai_cmd
  if (!rosidl_runtime_c__int32__Sequence__init(&msg->ai_cmd, 0)) {
    qulido_robot_msgs__srv__AiCompute_Response__fini(msg);
    return false;
  }
  return true;
}
...
qulido_robot_msgs__srv__AiCompute_Response__fini(qulido_robot_msgs__srv__AiCompute_Response * msg)
{
  ...
  // ai_cmd
  rosidl_runtime_c__int32__Sequence__fini(&msg->ai_cmd);
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  qulido_robot_msgs__srv__AiCompute_Response * msg = (qulido_robot_msgs__srv__AiCompute_Response *)allocator.allocate(sizeof(qulido_robot_msgs__srv__AiCompute_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(qulido_robot_msgs__srv__AiCompute_Response));
  bool success = qulido_robot_msgs__srv__AiCompute_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
qulido_robot_msgs__srv__AiCompute_Response__Sequence__init(qulido_robot_msgs__srv__AiCompute_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  qulido_robot_msgs__srv__AiCompute_Response * data = NULL;

  if (size) {
    data = (qulido_robot_msgs__srv__AiCompute_Response *)allocator.zero_allocate(size, sizeof(qulido_robot_msgs__srv__AiCompute_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = qulido_robot_msgs__srv__AiCompute_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        qulido_robot_msgs__srv__AiCompute_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
qulido_robot_msgs__srv__AiCompute_Response__Sequence__fini(qulido_robot_msgs__srv__AiCompute_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      qulido_robot_msgs__srv__AiCompute_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  qulido_robot_msgs__srv__AiCompute_Response__Sequence * array = (qulido_robot_msgs__srv__AiCompute_Response__Sequence *)allocator.allocate(sizeof(qulido_robot_msgs__srv__AiCompute_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = qulido_robot_msgs__srv__AiCompute_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
qulido_robot_msgs__srv__AiCompute_Response__Sequence__destroy(qulido_robot_msgs__srv__AiCompute_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    qulido_robot_msgs__srv__AiCompute_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
qulido_robot_msgs__srv__AiCompute_Response__Sequence__are_equal(const qulido_robot_msgs__srv__AiCompute_Response__Sequence * lhs, const qulido_robot_msgs__srv__AiCompute_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!qulido_robot_msgs__srv__AiCompute_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  qulido_robot_msgs__srv__AiCompute_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(qulido_robot_msgs__srv__AiCompute_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    qulido_robot_msgs__srv__AiCompute_Response * data =
      (qulido_robot_msgs__srv__AiCompute_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!qulido_robot_msgs__srv__AiCompute_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          qulido_robot_msgs__srv__AiCompute_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!qulido_robot_msgs__srv__AiCompute_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }

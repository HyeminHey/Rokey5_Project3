    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'qulido_robot_msgs.action.ExecuteMotion_Goal')
            logger.debug(
            ...
            from qulido_robot_msgs.msg import MotionSequence
            if MotionSequence.__class__._TYPE_SUPPORT is None:
                MotionSequence.__class__.__import_type_support__()
...
class ExecuteMotion_Goal(metaclass=Metaclass_ExecuteMotion_Goal):
    ...
    _fields_and_field_types = {
        'sequence': 'qulido_robot_msgs/MotionSequence',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['qulido_robot_msgs', 'msg'], 'MotionSequence'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from qulido_robot_msgs.msg import MotionSequence
        self.sequence = kwargs.get('sequence', MotionSequence())
    ...
    def sequence(self, value):
        if __debug__:
            from qulido_robot_msgs.msg import MotionSequence
            assert \
                isinstance(value, MotionSequence), \
                "The 'sequence' field must be a sub message of type 'MotionSequence'"
...
class Metaclass_ExecuteMotion_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'qulido_robot_msgs.action.ExecuteMotion_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_ExecuteMotion_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'qulido_robot_msgs.action.ExecuteMotion_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMotion_SendGoal_Request(metaclass=Metaclass_ExecuteMotion_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'qulido_robot_msgs/ExecuteMotion_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['qulido_robot_msgs', 'action'], 'ExecuteMotion_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from qulido_robot_msgs.action._execute_motion import ExecuteMotion_Goal
...
class Metaclass_ExecuteMotion_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'qulido_robot_msgs.action.ExecuteMotion_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from qulido_robot_msgs.action import _execute_motion
...
class ExecuteMotion_SendGoal(metaclass=Metaclass_ExecuteMotion_SendGoal):
    from qulido_robot_msgs.action._execute_motion import ExecuteMotion_SendGoal_Request as Request
    from qulido_robot_msgs.action._execute_motion import ExecuteMotion_SendGoal_Response as Response
...
class ExecuteMotion_GetResult_Response(metaclass=Metaclass_ExecuteMotion_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'qulido_robot_msgs/ExecuteMotion_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['qulido_robot_msgs', 'action'], 'ExecuteMotion_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from qulido_robot_msgs.action._execute_motion import ExecuteMotion_Result
...
class Metaclass_ExecuteMotion_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'qulido_robot_msgs.action.ExecuteMotion_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMotion_GetResult(metaclass=Metaclass_ExecuteMotion_GetResult):
    from qulido_robot_msgs.action._execute_motion import ExecuteMotion_GetResult_Request as Request
    from qulido_robot_msgs.action._execute_motion import ExecuteMotion_GetResult_Response as Response
...
class Metaclass_ExecuteMotion_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'qulido_robot_msgs.action.ExecuteMotion_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMotion_FeedbackMessage(metaclass=Metaclass_ExecuteMotion_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'qulido_robot_msgs/ExecuteMotion_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['qulido_robot_msgs', 'action'], 'ExecuteMotion_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from qulido_robot_msgs.action._execute_motion import ExecuteMotion_Feedback
...
class Metaclass_ExecuteMotion(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'qulido_robot_msgs.action.ExecuteMotion')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMotion(metaclass=Metaclass_ExecuteMotion):
    ...
    from qulido_robot_msgs.action._execute_motion import ExecuteMotion_Goal as Goal
    # The result message defined in the action definition.
    from qulido_robot_msgs.action._execute_motion import ExecuteMotion_Result as Result
    # The feedback message defined in the action definition.
    from qulido_robot_msgs.action._execute_motion import ExecuteMotion_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from qulido_robot_msgs.action._execute_motion import ExecuteMotion_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from qulido_robot_msgs.action._execute_motion import ExecuteMotion_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from qulido_robot_msgs.action._execute_motion import ExecuteMotion_FeedbackMessage as FeedbackMessage

...
#include "qulido_robot_msgs/msg/detail/motion_primitive__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const qulido_robot_msgs::msg::MotionPrimitive & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  qulido_robot_msgs::msg::MotionPrimitive & ros_message)
{
  // Member: primitive
  cdr >> ros_message.primitive;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = qulido_robot_msgs::msg::MotionPrimitive;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const qulido_robot_msgs::msg::MotionPrimitive *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<qulido_robot_msgs::msg::MotionPrimitive *>(
    untyped_ros_message);
...
{
  return &qulido_robot_msgs::msg::typesupport_fastrtps_cpp::_MotionPrimitive__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, qulido_robot_msgs, msg, MotionPrimitive)() {
  return &qulido_robot_msgs::msg::typesupport_fastrtps_cpp::_MotionPrimitive__handle;
}

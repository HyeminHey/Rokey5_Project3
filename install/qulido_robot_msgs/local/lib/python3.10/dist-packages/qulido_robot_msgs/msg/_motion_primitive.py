...
class MotionPrimitive(metaclass=Metaclass_MotionPrimitive):
    ...
    def __init__(self, **kwargs):
        ...
        self.primitive = kwargs.get('primitive', str())
        if 'target_pose' not in kwargs:
            self.target_pose = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.target_pose = kwargs.get('target_pose')
        self.gripper_width = kwargs.get('gripper_width', int())
    ...
    def primitive(self, value):
        if __debug__:
            assert \
                ...
                "The 'primitive' field must be of type 'str'"
    ...
    def target_pose(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 6, \
                "The 'target_pose' numpy.ndarray() must have a size of 6"
    ...
    def gripper_width(self, value):
        if __debug__:
            assert \
                ...
                "The 'gripper_width' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'gripper_width' field must be an integer in [-2147483648, 2147483647]"
